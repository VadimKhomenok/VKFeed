...
class VKFeediOSSnapshotTests: XCTestCase {
    ...
    func test_emptyFeed_snapshot() {
        ...
        assert(snapshot: feed.snapshot(), named: "EMPTY_FEED")
    }
    ...
    func test_nonEmptyFeed_snapshot() {
        ...
        assert(snapshot: feed.snapshot(), named: "FEED_WITH_CONTENT")
    }
    ...
    func test_errorFeed_snapshot() {
        ...
        assert(snapshot: feed.snapshot(), named: "FEED_WITH_ERROR_MESSAGE")
    }
    ...
    func test_errorImageLoading_snapshot() {
        ...
        assert(snapshot: feed.snapshot(), named: "FEED_WITH_FAILED_IMAGE_LOADING")
    }
