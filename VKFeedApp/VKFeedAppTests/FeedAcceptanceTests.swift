...
class FeedAcceptanceTests: XCTestCase {
    ...
    func test_launch_displaysRemoteFeedWhenCustomerHasConnectivity() {
        ...
        XCTAssertTrue(feed.canLoadMore, "Expected the Feed to show Load More")
        
        feed.simulateUserInitiatedLoadMoreAction()
        ...
        XCTAssertEqual(feed.renderedFeedImageData(at: 1), makeImageData1())
        XCTAssertEqual(feed.renderedFeedImageData(at: 2), makeImageData2())
        XCTAssertFalse(feed.canLoadMore, "Expected that it was the last page")
    }
    ...
    func test_onLaunch_displaysCachedRemoteFeedWhenCustomerHasNoConnectivity() {
        ...
        onlineFeed.simulateUserInitiatedLoadMoreAction()
    ...
    private func makeImageData0() -> Data { UIImage.makeTinyImage(color: .red).pngData()! }
    private func makeImageData1() -> Data { UIImage.makeTinyImage(color: .green).pngData()! }
    private func makeImageData2() -> Data { UIImage.makeTinyImage(color: .blue).pngData()! }
